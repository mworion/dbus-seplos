...
MbPage {
    ...
    property string c1: _b1.valid && _b1.text == "on" ? "#4790d0" : style.borderColor
    property string c2: _b2.valid && _b2.text == "on" ? "#4790d0": style.borderColor
    property string c3: _b3.valid && _b3.text == "on" ? "#4790d0": style.borderColor
    property string c4: _b4.valid && _b4.text == "on" ? "#4790d0": style.borderColor
    property string c5: _b5.valid && _b5.text == "on" ? "#4790d0": style.borderColor
    property string c6: _b6.valid && _b6.text == "on" ? "#4790d0": style.borderColor
    property string c7: _b7.valid && _b7.text == "on" ? "#4790d0": style.borderColor
    property string c8: _b8.valid && _b8.text == "on" ? "#4790d0": style.borderColor
    property string c9: _b9.valid && _b9.text == "on" ? "#4790d0": style.borderColor
    property string c10: _b10.valid && _b10.text == "on" ? "#4790d0": style.borderColor
    property string c11: _b11.valid && _b11.text == "on" ? "#4790d0": style.borderColor
    property string c12: _b12.valid && _b12.text == "on" ? "#4790d0": style.borderColor
    property string c13: _b13.valid && _b13.text == "on" ? "#4790d0": style.borderColor
    property string c14: _b14.valid && _b14.text == "on" ? "#4790d0": style.borderColor
    property string c15: _b15.valid && _b15.text == "on" ? "#4790d0": style.borderColor
    property string c16: _b16.valid && _b16.text == "on" ? "#4790d0": style.borderColor
    property string c17: _b17.valid && _b17.text == "on" ? "#4790d0": style.borderColor
    property string c18: _b18.valid && _b18.text == "on" ? "#4790d0": style.borderColor
    property string c19: _b19.valid && _b19.text == "on" ? "#4790d0": style.borderColor
    property string c20: _b20.valid && _b20.text == "on" ? "#4790d0": style.borderColor
